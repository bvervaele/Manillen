...
using Manillen.Service.Helpers;
...
namespace Manillen.Service.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class UserController : ControllerBase
    {
        private readonly ManillenDbContext _context;
        private readonly UserConnectionService _userConnectionService;

        public UserController(ManillenDbContext manillenDbContext, UserConnectionService userConnectionService)
        {
            this._context = manillenDbContext;
        ...
        public async Task<IActionResult> Login([FromBody] User userObj)
        {
            ...
            var user = await _context.Users.FirstOrDefaultAsync(user => user.Username == userObj.Username);
        ...
        public async Task<IActionResult> Register([FromBody] User userObj)
        {
            ...
            var user = await _context.Users.AnyAsync(user => user.Username == userObj.Username);
        ...
        private string CreateRefershToken()
        {
            ...
            var tokenInUser = _context.Users.Any(user => user.RefreshToken == refershToken);
